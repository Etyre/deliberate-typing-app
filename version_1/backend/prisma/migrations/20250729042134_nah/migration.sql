/*
  ...
  - The values [ADDED_FROM_PERSONAL_CORPUS] on the enum `TrackedTokenSource` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "TrackedTokenSource_new" AS ENUM ('MISSED_IN_PRACTICE', 'ADDED_MANUALLY', 'BOTH_MISSED_AND_ADDED_MANUALLY');
